        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="{{ route('shoper.product.create') }}" class="btn btn-primary" > + Add New</a>
            </ol>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
	$(function products(){
      ...
      "searching":true,
      "ajax":{
        "url": "{{ route('shoper.product.index') }}", 
        "data":function(e) {
		  ...
		  e.brand_id =$("#brand_id").val();
			...
			columns:[
				...
				{data:'productlogo'  ,name:'productlogo'},
				{data:'name'  ,name:'name'},
...
$(document).ready(function(){
  ...
  $('body').on('click','.edit', function(){
    let id=$(this).data('id');
	url="shopkeeper/product/edit/"+id;
