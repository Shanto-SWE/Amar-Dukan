...
<div class="modal fade" id="categoryModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('shoper.category.store') }}" method="Post" enctype="multipart/form-data">
      	@csrf
...
<script type="text/javascript">
	$(function category(){
		var table=$('.ytable').DataTable({
			processing:true,
			serverSide:true,
            ajax:"{{ route('shoper.category.index') }}",
...
// edit model open
	$('body').on('click','.edit', function(){
		...
		$.get("shopkeeper/category/edit/"+cat_id, function(data){
