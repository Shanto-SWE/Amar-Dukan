...
.search-icon{
   padding-right:40px;
    ...
    <input type="text" id="search-bar" name="search_district" placeholder="Search Your District..."  autocomplete="off" required="required">
...
<h4>Find us in these cities and many more!</h4>
<div class="row">
