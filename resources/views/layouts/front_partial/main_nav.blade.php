...
<nav class="main_nav sticky-fixed">
			<div class="container">
				<div class="row">
					<div class="col">
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								@php
                                  ...
                                  @endphp
									<li class="hassubs">
									<img class="catmenuimg "src="{{$row->category_logo,}}" alt="">	<a href="{{route('subcategorylist.show',$row->category_slug)}}">	 {{ $row->category_name }}<i class="fas fa-chevron-right"></i></a>
										...
										@foreach($subcategory as $row)
											...
											<li class="hassubs">
											<img class="catmenuimg img-fluid"src="{{$row->subcat_logo,}}" alt=""><a href="{{route('categorywishproduct.show',$row->Subcat_slug)}}">{{ $row->Subcategory_name }}</a>
