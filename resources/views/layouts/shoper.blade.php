...
<div class="wrapper">
  ...
  <!-- Navbar -->
@include('layouts.shoper_partial.navbar')

    <!-- Main Sidebar Container -->
  @include('layouts.shoper_partial.sidebar')

 

 
 @yield('shoper_content')
...
$('.shopernotificationbell').click(function(){

$.ajax({

   url: "{{ url("/shopkeeper/notification/status/change/") }}/",
   type: 'get',
   success: function(data) {
     $('.shopernotificationstatus').html('0');
    ...
    // change seen status
    $('.shoperseen').click(function(){
    var id=$(this).data('id');

   $.ajax({

   url: "{{ url("/shopkeeper/seen/status/change/") }}/"+id,
   type: 'get',
   success: function(data) {     
