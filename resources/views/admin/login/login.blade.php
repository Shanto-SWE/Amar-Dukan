      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 contents offset-3" >
            ...
            <div class="mb-6">
                  <h3 class="text-center">Sign In to Admin panal</h3>
...
@endif
                ...
                @if ($errors->any())
                  ...
                  if(isset($_COOKIE['admin_email']) && ($_COOKIE['admin_password'])){
                    $login_email = Cookie::get('admin_email');
                    $login_password = Cookie::get('admin_password');
                  ...
                  <div class="d-flex mb-5 align-items-center">
                    <label class="control control--checkbox mb-0"><span class="caption">Remember me</span>
                      <input type="checkbox" name="admin_rememberme" {{$is_remember}}/>
                      <div class="control__indicator"></div>
                    </label>
                    <span class="ml-auto"><a href="{{route('admin.password.forget')}}" class="forgot-pass">Forgot Password</a></span> 
                  </div>
