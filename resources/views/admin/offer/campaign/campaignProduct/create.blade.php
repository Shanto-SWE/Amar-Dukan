...
@section('title','Campaign_Product_create')
...
<style type="text/css">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
       <form action="{{route('campaign.product.store')}}" method="post" enctype="multipart/form-data" id="add_form">
        @csrf
       	<div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-lg-4">
                    <label for="exampleInputEmail1">Shop Name <span class="text-danger">*</span> </label>
                      <select class="form-control" name="campaign_id" id="shop_id" required>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-lg-4">
                      ...
                      <input type="text" name="discount_price" value="{{ old('discount_price') }}" class="form-control" required="">
                    </div>
