...
<div class="container" style="padding-left:30px;">
    ...
    <tr>
        ...
        <tr>
            ...
            <td>{{$productview->subcategory->Subcategory_name}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            @if($productview->product_slider==1)
            <td>Active</td>
            @else 
            <td>Inactive</td>
            @endif
        ...
        <tr>
            <td>Trendy Product :</td>
            @if($productview->trendy_prodcut==1)
            <td>Active</td>
            @else 
            <td>Inactive</td>
            @endif
