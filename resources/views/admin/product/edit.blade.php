...
<style type="text/css">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
       <form action="{{route('product.update')}}" method="post" enctype="multipart/form-data" id="edit_form">
        @csrf
       	<div class="row">
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-lg-4">
                      ...
                      <select class="form-control" name="shop_id" id="edit_category">
                        @foreach($shop as $row)
                         <option value="{{ $row->id }}"  @if($row->id==$product->shop_id) selected="" @endif>{{ $row->shop_name }}</option>
                        @endforeach 
                      </select>
                    </div>
                    <div class="form-group col-lg-4">
                    <label for="exampleInputEmail1">Category Name <span class="text-danger">*</span> </label>
                    <select class="form-control" name="category_id" id="edit_subcategory">
...
<script type="text/javascript">
  $("input[data-bootstrap-switch]").each(function(){
    ...
    //ajax request send for collect category for edit 
   ...
   $("#edit_subcategory").change(function(){
      var id = $(this).val();
      $.ajax({
